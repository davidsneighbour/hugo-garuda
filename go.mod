module github.com/davidsneighbour/dnb-hugo-garuda

go 1.15

require (
	github.com/davidsneighbour/dnb-hugo-libs/bootstrap-icons v1.1.1 // indirect
	github.com/davidsneighbour/dnb-hugo-libs/bootstrap5 v1.1.0 // indirect
